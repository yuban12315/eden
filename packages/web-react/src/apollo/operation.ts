...
export type GetNoteConentQuery = {
  __typename?: "Query";
  content: {
    __typename?: "GetNoteContentResponse";
    title: string;
 ...
 * });
 */
export function useGetNoteConentQuery(
  baseOptions: Apollo.QueryHookOptions<
    GetNoteConentQuery,
    GetNoteConentQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<GetNoteConentQuery, GetNoteConentQueryVariables>(
    GetNoteConentDocument,
    options
  );
}
export function useGetNoteConentLazyQuery(
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<GetNoteConentQuery, GetNoteConentQueryVariables>(
    GetNoteConentDocument,
    options
  );
}
export type GetNoteConentQueryHookResult = ReturnType<
  typeof useGetNoteConentQuery
>;
export type GetNoteConentLazyQueryHookResult = ReturnType<
  typeof useGetNoteConentLazyQuery
>;
export type GetNoteConentQueryResult = Apollo.QueryResult<
  GetNoteConentQuery,
  GetNoteConentQueryVariables
>;
